...
BASE_OUT_DIR="$PROJECT_ROOT/features_store/p3_run_full_aug_scaf_off_k5_then_k1_reuse_20260314"
...
run_case \
    "p3_1_1_full_aug_scaf_off_k5_cache_build" \
    "$K5_OUT_DIR" \
    --k_mode 5

run_case \
    "p3_1_1_full_aug_scaf_off_k1_cache_reuse" \
    "$K1_OUT_DIR" \
    --k_mode 1
